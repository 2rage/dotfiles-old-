...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/2rage/dotfiles/configure.sh)"
```
...
[Fork holman's](https://github.com/holman/dotfiles/fork) or [Fork mine](htps://github.com/2rage/dotfiles/fork), remove what you don't
...
[open an issue](https://github.com/2rage/dotfiles/issues) on this repository
